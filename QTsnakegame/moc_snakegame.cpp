...
QT_MOC_LITERAL(1, 10, 9), // "SnakeMove"
QT_MOC_LITERAL(2, 20, 0) // ""

    },
    "SnakeGame\0SnakeMove\0"
};
...
void SnakeGame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SnakeGame *_t = static_cast<SnakeGame *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SnakeMove(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject SnakeGame::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SnakeGame.data,
      qt_meta_data_SnakeGame,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SnakeGame::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SnakeGame.stringdata0))
        return static_cast<void*>(const_cast< SnakeGame*>(this));
